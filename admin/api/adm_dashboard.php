...
if (isset($_GET["validaciones"]) && !empty($_GET["validaciones"])) {
    ...
    if ($strTipoValidacion == "insert_home") {
        ...
        $var_consulta = "UPDATE about 
        SET inf_general = '$inf_general' ,
            img_mision = '$img_mision',
            ico_mision = '$ico_mision' ,
            title_mision = '$title_mision' ,
            content_mision = '$content_mision' ,
            img_plan = '$img_plan' ,
            ico_plan = '$ico_plan' ,
            title_plan = '$title_plan' ,
            content_plan = '$content_plan' ,
            img_vision = '$img_vision' ,
            ico_vision = '$ico_vision',
            title_vision = '$title_vision',
